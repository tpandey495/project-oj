  ...
  const settings = {
    ...
    nextArrow: (
      <ArrowForwardIosIcon
        ...
        sx={{ ...style.NavIconStyle, ...style.NavIconStyleRight }}
      />
    ),
    prevArrow: (
      <ArrowBackIosIcon className="prev-arrow" sx={{ ...style.NavIconStyle }} />
    ),
    responsive: [
      {
        breakpoint: 1500,
